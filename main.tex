...
\begin{frame}{Transformer}
    \begin{figure}
        \begin{minipage}{0.55\textwidth}
            \centering
            \includegraphics[width=\textwidth]{architectures/attention.png}
        \end{minipage}%
        \hfill
        \begin{minipage}{0.3\textwidth}
            \centering
            \includegraphics[width=\textwidth]{architectures/transformer.png}
        \end{minipage}
        \hfill
    \end{figure}
\end{frame}
...
\begin{frame}[t]{Transport continuous equation}
    ...
    \]
    con $f$ funzione regolare. Si fissa $v = (0.2, \, 0.2)$ e si approssima l'operatore $\mathcal{G}: f\to u_{T=1}$.
    \begin{center}
...
\begin{frame}[t]{Transport discontinuous equation}
    ...
    u_{t} + v \cdot \nabla u = 0 \quad \text{in } \Omega \times (0, T), \quad\quad u_{0}(x, y) = f(x, y),
    \]
    con $f$ funzione discontinua. Si fissa $v = (0.2, \, 0.2)$ e si approssima l'operatore $\mathcal{G}: f\to u_{T=1}$.
    \begin{center}
        \begin{minipage}{0.24\textwidth}
...
\begin{frame}[t]{Poisson Equation}
    ...
    \]
    Si approssima l'operatore $\mathcal{G}: f\to u$.
    \begin{center}
        \begin{minipage}{0.24\textwidth}
...
\begin{frame}[t]{Navier-Stokes Equation}
    ...
    \]
    Dove $\nu = 4 \cdot 10^{-4}$ e si approssima l'operatore soluzione $\mathcal{G}: f\to u_{T=1}$.
    \begin{center}
        \begin{minipage}{0.24\textwidth}
...
\begin{frame}[t]{Wave Equation}
    ...
    \]
    Dove $c = 0.1$ e si approssima l'operatore soluzione $\mathcal{G}: f\to u_{T=5}$.
    \begin{center}
        \begin{minipage}{0.24\textwidth}
...
\begin{frame}[t]{Allen-Cahn equation}
   ...
   \] 
   Dove $\varepsilon = 220 $ e si approssima l'operatore soluzione $\mathcal{G}: f\to u_{T}$ con $T = 0.0002$.
    \begin{center}
        \begin{minipage}{0.24\textwidth}
